/*! For license information please see 5384.a64478ac.js.LICENSE.txt */
"use strict";(self.webpackChunkvue2_demo=self.webpackChunkvue2_demo||[]).push([["5384"],{89757:function(e,t,a){a.r(t),a.d(t,{conf:()=>r,language:()=>_});var r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function o(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}var n=o("true false"),i=o(`
			  alias
			  break
			  case
			  const
